...
player.sIdle            = sBenIdle;
player.sCrouch          = sBenCrouch;
player.sJump            = sBenCrouch;
player.sDash            = sBenDash;
player.sRun             = sBenWalk;
player.sWalk            = sBenWalk;
player.sCrawl           = sBenCrouch;
player.sTurn            = sBenTurn;
player.sTiltTurn        = sBenTurn;
player.sSmashTurn       = sBenTurn;
player.sRunTurn         = sBenTurn;
player.sSkid            = sBenCrouch;
player.sLand            = sBenCrouch;
player.sRoll            = sBenCrouch;
player.sDodge           = sBenTurn;
player.sShield          = sBenTurn;
