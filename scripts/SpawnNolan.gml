...
player.sIdle            = sNolanIdle;
player.sCrouch          = sNolanCrouch;
player.sJump            = sNolanCrouch;
player.sDash            = sNolanDash;
player.sRun             = sNolanWalk;
player.sWalk            = sNolanWalk;
player.sCrawl           = sNolanCrouch;
player.sTurn            = sNolanTurn;
player.sTiltTurn        = sNolanTurn;
player.sSmashTurn       = sNolanTurn;
player.sRunTurn         = sNolanTurn;
player.sSkid            = sNolanCrouch;
player.sLand            = sNolanCrouch;
player.sRoll            = sNolanCrouch;
player.sDodge           = sNolanTurn;
player.sShield          = sNolanTurn;
