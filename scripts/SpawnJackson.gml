...
player.sIdle            = sJacksonIdle;
player.sCrouch          = sJacksonCrouch;
player.sJump            = sJacksonCrouch;
player.sDash            = sJacksonDash;
player.sRun             = sJacksonWalk;
player.sWalk            = sJacksonWalk;
player.sCrawl           = sJacksonCrouch;
player.sTurn            = sJacksonTurn;
player.sTiltTurn        = sJacksonTurn;
player.sSmashTurn       = sJacksonTurn;
player.sRunTurn         = sJacksonTurn;
player.sSkid            = sJacksonSkid;
player.sLand            = sJacksonCrouch;
player.sRoll            = sJacksonSkid;
player.sDodge           = sJacksonTurn;
player.sShield          = sJacksonShield;
...
player.sLedgeGrab       = sJacksonLedgeGrab;

// Air sprites
player.sHitstun         = sJacksonHitstun;
player.sAirborne        = sJacksonJump;
player.sTumble          = sJacksonHelpless;
player.sHelpless        = sJacksonHelpless;
...
// Aerial sprites
player.sFAir            = sJacksonFair;
player.sBAir            = sJacksonBair;
