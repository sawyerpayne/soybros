...
player.sIdle            = sAliIdle;
player.sCrouch          = sAliCrouch;
player.sJump            = sAliCrouch;
player.sDash            = sAliDash;
player.sRun             = sAliWalk;
player.sWalk            = sAliWalk;
player.sCrawl           = sAliCrouch;
player.sTurn            = sAliTurn;
player.sTiltTurn        = sAliTurn;
player.sSmashTurn       = sAliTurn;
player.sRunTurn         = sAliTurn;
player.sSkid            = sAliIdle;
player.sLand            = sAliCrouch;
player.sRoll            = sAliCrouch;
player.sDodge           = sAliTurn;
player.sShield          = sAliTurn;
