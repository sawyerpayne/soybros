...
player.sDash            = sJacksonWalk;
player.sRun             = sJacksonWalk;
player.sWalk            = sJacksonWalk;
player.sCrawl           = sJacksonCrawl;
player.sTurn            = sJacksonIdle;
player.sTiltTurn        = sJacksonIdle;
player.sSmashTurn       = sJacksonIdle;
player.sRunTurn         = sJacksonIdle;
player.sSkid            = sJacksonIdle;
player.sLand            = sJacksonCrouch;
player.sRoll            = sJacksonCrouch;
player.sDodge           = sJacksonJump;
...
player.playerCharacter  = characters.hansen;
